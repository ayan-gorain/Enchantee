...
class CartController extends GetxController{
  ...
  void removeProduct(Product product){
    ...
    Get.snackbar("Product Deleted", "You have deleted the ${product.name} to the cart",
      snackPosition: SnackPosition.BOTTOM,
      duration: Duration(seconds: 3),
    );
    }
  get products => _products;
  get productSubtotal =>_products.entries.map((
      product)=>product.key.price*product.value).toList();
